...
config_args='-des -Dprefix=/workspace/destdir -Duseshrplib -Dcc="/opt/bin/cc -target x86_64-apple-darwin14 " -Dsysroot=/opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root -Dld="/opt/bin/clang --sysroot /opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root" -Dar=/opt/bin/ar -Dtargetarch=x86_64-apple-darwin14 -Dusecrosscompile -Dhostgenerate=/workspace/srcdir/perl-5.30.0/host/generate_uudmap -Dhostperl=/workspace/srcdir/perl-5.30.0/host/miniperl -Dhostosname=linux -Dosname=darwin'
config_argc=13
config_arg1='-des'
config_arg2='-Dprefix=/workspace/destdir'
config_arg3='-Duseshrplib'
config_arg4='-Dcc=/opt/bin/cc -target x86_64-apple-darwin14 '
config_arg5='-Dsysroot=/opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root'
config_arg6='-Dld=/opt/bin/clang --sysroot /opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root'
config_arg7='-Dar=/opt/bin/ar'
...
castflags='0'
cat='cat'
cc='/opt/bin/cc -target x86_64-apple-darwin14 --sysroot=/opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root'
cccdlflags=' '
ccdlflags=' '
...
ksh=''
ld='/opt/bin/clang --sysroot /opt/x86_64-apple-darwin14/x86_64-apple-darwin14/sys-root '
ld_can_script='undef'
